...
- use `uv init --python 3.14 && uv venv` to inititialize and create virtual environment
...
- only use `uv` for managing virtual environment and package dependencies
- use `uv init --python 3.14 && uv venv` to initialize and create virtual environment
